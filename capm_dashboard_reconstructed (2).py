...
def render_result_tabs(r):
    overview, score_tab, performance, sip_tab, risk, capm, charts, validation, data = st.tabs(
        ["Overview", "Score", "Performance", "SIP Backtest", "Risk", "CAPM", "Charts", "Validation", "Data"]
    )
    with overview:
        a, b, c = st.columns(3)
        with a:
